...
public class toyforjoy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_toyforjoy);

        donate_material_intent = new Intent(toyforjoy.this, knowing_goonj.class);
        ...
        money_offline_intent = new Intent(toyforjoy.this, offline_donation_webview.class);
        ...
        money_online_intent = new Intent(toyforjoy.this, patym_donation_webview.class);
