...
public class offline_donation_webview extends AppCompatActivity {
    WebView mWebView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_offline_donation_webview);

        progressBar = (ProgressBar) findViewById(R.id.progressbar);
        mWebView = (WebView) findViewById(R.id.webView);
        if (savedInstanceState == null) {
            mWebView.loadUrl("https://goonj.org/contribute-offline-indian/");
        }
