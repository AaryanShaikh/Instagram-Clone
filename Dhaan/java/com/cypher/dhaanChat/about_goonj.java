...
public class about_goonj extends AppCompatActivity {
    TextView  knowning_goonj,initiatives,founders,offices,dropping_centers,stories,awards,faqs,donate_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        donate_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(about_goonj.this,donation.class);
                Toast.makeText(about_goonj.this,"Donate to Goonj",Toast.LENGTH_SHORT).show();
